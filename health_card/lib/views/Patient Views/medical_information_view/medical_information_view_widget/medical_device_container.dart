...
class MedicalDeviceContainer extends StatelessWidget {
  const MedicalDeviceContainer({super.key, this.medicalInformation});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              TextWidget(
                text:
                    medicalInformation!.medicalCondition ?? 'No Medical Device',
              ),
            ],
          ),
        ),
